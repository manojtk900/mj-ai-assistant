...
def start_gui():
    ...
    status_label = tk.Label(root, fg="#00ffcc", bg="black")
    status_label.pack()

    command_label = tk.Label(root, fg="white", bg="black")
    command_label.pack()

    response_label = tk.Label(root, fg="#ffff66", bg="black", wraplength=600)
    response_label.pack(pady=10)

    canvas = tk.Canvas(root, width=300, height=300, bg="black", highlightthickness=0)
    canvas.pack()

    circle = canvas.create_oval(50, 50, 250, 250, outline="#00ffff", width=2)
    ...
    tk.Button(root, text="Type Command", command=send_text, bg="#00ffff").pack()
